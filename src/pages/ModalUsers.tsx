...
interface Props {
  ...
  handleUpdateCustomer: (customer: User) => void;
  ...
  async function getLastInvoice() {
    try {
      ...
      setInvoice({
        ...
        service: {
          values: {
            otherWithholdingsValue:
              lastInvoice.service.values.otherWithholdingsValue,
            otherWithholdingsRetained:
              lastInvoice.service.values.otherWithholdingsRetained,
          },
          ...
          {activeTab === "edit" && (
            <div className="space-y-4">
              ...
              <div>
                ...
                <input
                  type="text"
                  value={customer.corporateName || customer.name}
                  onChange={(e) =>
              ...
              <div>
                ...
                <input
                  type="text"
                  value={customer.enterprise.document.type}
                  onChange={(e) =>
                    setCustomer({
                      ...customer,
                      enterprise: {
              ...
              <div>
                ...
                <input
                  type="text"
                  value={customer.enterprise.document.number}
                  onChange={(e) =>
                    setCustomer({
                      ...customer,
                      enterprise: {
              ...
              <div>
                ...
                <input
                  type="text"
                  value={customer.enterprise.municipalRegistration}
                  onChange={(e) =>
                    setCustomer({
                      ...customer,
                      enterprise: {
              ...
              <div>
                ...
                <input
                  type="text"
                  value={customer.enterprise.stateRegistration}
                  onChange={(e) =>
                    setCustomer({
                      ...customer,
                      enterprise: {
